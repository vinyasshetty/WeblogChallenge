...
a new session should start for the same user when he appears again.Same should happen 
for other users independently based on their timestamps.

Now the challenge here was to create personalized "session id" for each clients based on window time.
